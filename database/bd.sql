...
CREATE TABLE investment_product (
    ...
    CONSTRAINT investment_product_type_investment_check CHECK (
        type_investment IN ('CDB', 'TESOURO', 'POUPANCA')
    )
);
...
CREATE TABLE investment_transaction (
    ...
    CONSTRAINT investment_transaction_type_check CHECK (
        "type" IN ('INVEST', 'REDEEM', 'EARN')
    ),
...
CREATE TABLE transactions (
    ...
    CONSTRAINT transaction_type_transaction_check CHECK (
        type_transaction IN (
            'DEPOSIT',
            'WITHDRAW',
            'TRANSFER_IN',
