...
<body>
    <div class="container">
                ...
                <tbody>
                    <c:forEach var="investimento" items="${listaInvestimentos}">
                        <tr>
                            ...
                            <td><fmt:formatNumber value="${investimento.amount}" type="currency" currencySymbol="R$ "/></td>
                            <td>
                                <c:if test="${not empty investimento.startDate}">
                                    ${String.format('%02d', investimento.startDate.dayOfMonth)}/${String.format('%02d', investimento.startDate.monthValue)}/${investimento.startDate.year}
                                </c:if>
                            </td>
                            <td>
        ...
        <section id="formNovoInvestimento" class="form-container" style="display: none;">
            ...
            <p>Saldo disponível em conta: <strong>R$ <fmt:formatNumber value="${conta.balance}" type="number" minFractionDigits="2"/></strong></p>
            ...
            <form action="Investir" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="valor" name="valor" class="form-control" step="0.01" min="1" required>
                </div>
                <div class="form-group">
