...
import="com.mycompany.webapplication.entity.Users,com.mycompany.webapplication.entity.Account"
%><%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %> <% Users
usuario = (Users) session.getAttribute("usuario"); if (usuario == null) {
...
<html lang="pt-BR">
  ...
  <body>
    <div class="container">
      ...
      <div class="user-info">
        Olá, ${usuario.name} | Saldo atual: R$ ${conta.balance}
      </div>
      ...
      <form
        id="formSaque"
        action="${pageContext.request.contextPath}/Sacar"
        method="post"
      >
      ...
      >
        ${mensagem}
        <c:if test="${not empty alerta}"> <br />${alerta} </c:if>
      </div>
    </div>
